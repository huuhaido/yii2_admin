...
<?php $this->beginPage() ?>
                            ...
                            <div class="page-quick-sidebar-chat-users" data-rail-color="#ddd"
                                ...
                                <ul class="media-list list-items">
                                    <li class="media">
                                        ...
                                        <img class="media-object" src="<?php echo Url::base();?>/images/avatar3.jpg" alt="...">
                                    ...
                                    <li class="media">
                                        <img class="media-object" src="<?php echo Url::base();?>/images/avatar1.jpg" alt="...">
                                    ...
                                    <li class="media">
                                        ...
                                        <img class="media-object" src="<?php echo Url::base();?>/images/avatar4.jpg" alt="...">
                                    ...
                                    <li class="media">
                                        <img class="media-object" src="<?php echo Url::base();?>/images/avatar2.jpg" alt="...">
                                ...
                                <ul class="media-list list-items">
                                    <li class="media">
                                        ...
                                        <img class="media-object" src="<?php echo Url::base();?>/images/avatar6.jpg" alt="...">
                                    ...
                                    <li class="media">
                                        ...
                                        <img class="media-object" src="<?php echo Url::base();?>/images/avatar7.jpg" alt="...">
                                    ...
                                    <li class="media">
                                        <img class="media-object" src="<?php echo Url::base();?>/images/avatar8.jpg" alt="...">
                                    ...
                                    <li class="media">
                                        ...
                                        <img class="media-object" src="<?php echo Url::base();?>/images/avatar9.jpg" alt="...">
                                    ...
                                    <li class="media">
                                        <img class="media-object" src="<?php echo Url::base();?>/images/avatar10.jpg"
                                             alt="...">
                                    ...
                                    <li class="media">
                                        ...
                                        <img class="media-object" src="<?php echo Url::base();?>/images/avatar11.jpg"
                                             alt="...">
                            ...
                            <div class="page-quick-sidebar-item">
                                <div class="page-quick-sidebar-chat-user">
                                    ...
                                    <div class="page-quick-sidebar-chat-user-messages">
                                        <div class="post out">
                                            <img class="avatar" alt="" src="<?php echo Url::base();?>/images/avatar3.jpg"/>
                                        ...
                                        <div class="post in">
                                            <img class="avatar" alt="" src="<?php echo Url::base();?>/images/avatar2.jpg"/>
    ...
    <script type="text/javascript">
        ...
        var currController = '<?php echo Yii::$app->controller->id;?>';console.log(currController);
        var currAction = '<?php echo Yii::$app->controller->action->id;?>';console.log(currAction);

        if (currController == 'dashboard') {
            if (currAction == 'index')
                activeMenu(1, 1);
            else if (currAction == 'index_2')
                activeMenu(1, 2);
            else if (currAction == 'index_3')
                activeMenu(1, 3);
